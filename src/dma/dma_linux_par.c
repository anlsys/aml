...
struct aml_dma_ops aml_dma_linux_par_ops = {
        .create_request = aml_dma_linux_par_create_request,
        .destroy_request = aml_dma_linux_par_destroy_request,
        .wait_request = aml_dma_linux_par_wait_request,
        .barrier = NULL,
        .fprintf = aml_dma_linux_par_fprintf,
};
