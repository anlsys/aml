...
static inline int aml_copy_2d(void *dst, const size_t *dst_pitch, const void *src, const size_t *src_pitch, const size_t *elem_number, size_t elem_size)
{
...
int aml_copy_nd(size_t d, void *dst, const size_t *dst_pitch, const void *src, const size_t *src_pitch, const size_t *elem_number, const size_t elem_size)
{
        ...
        if(d == 1)
                ...
                aml_copy_2d(dst, dst_pitch, src, src_pitch, elem_number, elem_size);
        else {
                assert( dst_pitch[d-2] >= elem_number[d-2] );
                ...
                for(int i = 0; i < elem_number[d-1]; i++) {
                        aml_copy_nd(d-1, dst, dst_pitch, src, src_pitch, elem_number, elem_size);
                        dst += dst_product_pitch;
                        src += src_product_pitch;
                }
        }
