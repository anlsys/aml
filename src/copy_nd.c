...
static inline int aml_copy_t2d(void *dst, const size_t *cumul_dst_pitch, const void *src, const size_t *cumul_src_pitch, const size_t *elem_number, const size_t elem_size)
{
...
int aml_copy_tnd_helper(size_t d, void *dst, size_t *cumul_dst_pitch, const void *src, const size_t *cumul_src_pitch, const size_t *elem_number, const size_t elem_size)
{
        if(d == 2)
                aml_copy_t2d(dst, cumul_dst_pitch, src, cumul_src_pitch, elem_number, elem_size);
        else {
                size_t dst_pitch = cumul_dst_pitch[d-3];
                cumul_dst_pitch[d-3] = cumul_dst_pitch[d-2];
                for(int i = 0; i < elem_number[d-1]; i++) {
                        aml_copy_tnd_helper(d-1, dst, cumul_dst_pitch, src, cumul_src_pitch, elem_number, elem_size);
                        dst += dst_pitch;
                        src += cumul_src_pitch[d-2];
                }
        }
