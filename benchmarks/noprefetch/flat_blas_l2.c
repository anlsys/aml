...
int main(int argc, char *argv[])
{
	...
	// TODO Change labels
        char *label[10] = {"Copy:	", "Scale:	", "Triad:	",
		           "Asum:	", "Dot:	", "Norm:	",
			   "Swap:	", "Max ID:	", "RotP:	",
			   "RotM:	"};
...
//			verify_f[i](memsize, a, b, c, dscalar, res);
		...
		// m nb of rows of A, n nb of columns of A, kl nb of sub-
		// diagonals of A, ku nb of super-diagonals of A
		// void dgbmv(bool trans, size_t m, size_t n, int kl, int ku, double alpha,
		//		double beta, double **a, double *x, double *y);
        
		// void dgemv(bool trans, size_t m, size_t n, double alpha, double beta,
		//		double **a, double *x, double *y);
        
		// void dger(size_t m, size_t n, double alpha, double **a, double *x, double *y);

		// void dsbmv(char uplo, size_t n, int k, double alpha, double beta, double *a,
		//		double *x, double *y);
        
		// void dspmv(char uplo, size_t n, double alpha, double beta, double *a,
		//		   double *x, double *y);
        
		// TODO
		// void dspr(char uplo, size_t n, double alpha, double *a, double *x);
		// void dspr2(char uplo, size_t n, double alpha, double *a, double *x, double *y);
		// void dsymv(char uplo, size_t n, double alpha, double beta, double *a,
		//		   double *x, double *y);
		// void dsyr(char uplo, size_t n, double alpha, double *a, double *x);
		// void dsyr2(char uplo, size_t n, double alpha, double *a, double *x, double *y);
